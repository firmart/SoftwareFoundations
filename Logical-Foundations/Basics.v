...
(* Fixpoint decreasing (x : nat) : nat :=
  match x with
    | 0 => 0
    | S x' => decreasing (x' * 3 - x' * 2)
  end.
*)
(** [] *)
...
Fixpoint bin_to_nat (b : bin) : nat :=
  match b with
  | BO => O
  | S1 b' => (bin_to_nat b' + bin_to_nat b')
  | S2 b' => S (bin_to_nat b' + bin_to_nat b')
  end.
  
Example test_bin_incr1: bin_to_nat BO = O.
Proof. reflexivity. Qed.
