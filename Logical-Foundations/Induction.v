...
Lemma double_neg_eq_id : forall b : bool, negb (negb b) = b.
...
Proof.
  induction n as [|n' IHn'].
  - simpl. reflexivity.
  - rewrite -> IHn'. rewrite -> double_neg_eq_id. simpl. reflexivity.
Qed.
...
(* destruct : one step, induction : use induction hypothesis *)
(** [] *)
...
Lemma mult_comm_lemma : forall n m, m * S n = m + m * n.
Proof.
  intros n m.
...
Theorem andb_false_r : forall b : bool,
  andb b false = false.
Proof. intros. rewrite -> andb_commutative. simpl. reflexivity. Qed.
...
Theorem all3_spec : forall b c : bool,
  ...
  = true.
Proof.
  intros. destruct b. destruct c. reflexivity. reflexivity. reflexivity. 
Qed.
...
Proof.
  ...
  - rewrite -> mult_comm_lemma. rewrite -> mult_comm_lemma. rewrite -> mult_comm_lemma. rewrite -> plus_swap. rewrite -> IHp'. rewrite <- plus_assoc. rewrite <- plus_assoc. rewrite -> plus_swap. reflexivity.
Qed.   
...
Proof.
  ...
  replace (n+m) with (m+n). reflexivity. apply plus_comm.
Qed.
