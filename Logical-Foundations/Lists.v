...
Inductive natlistpair : Type :=
| listpair : natlist -> natlist -> natlistpair.

Notation "( l1 , l2 )" := (listpair l1 l2).
...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  match s1 with 
  | nil => true
  | h1 :: t1 => if member h1 s2 then subset t1 (remove_one h1 s2) else false
  end.
...
Proof.
  ...
  - reflexivity.
  - simpl. case_eq (beq_nat h 0). intuition. intuition. simpl. rewrite <- IHt. reflexivity.
Qed. 
(** [] *)
